...
public class AsrMain {
    ...
    private final String APP_KEY = "kB1OWB3ZsVL3Elt6TjB1aPBw";

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
    private final String SECRET_KEY = "l1y5gAEhZGxBS4FCKiqykgz4I9apDIXn";

    // 需要识别的文件
    private final String FILENAME = "C:\\Users\\玩偶\\Desktop\\格式工厂\\iat_pcm_16k.pcm";
